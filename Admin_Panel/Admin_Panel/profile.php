    ...
    if ($getUinfo) {
     ...
     ?>
          ...
          <form class="" action="" method="POST">
              ...
              <div class="form-group">
                <label for="username">Job Info</label>
                <input type="text" name="username" value="<?php echo $getUinfo->job; ?>" class="form-control">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" id="mobile" name="mobile" value="<?php echo $getUinfo->description; ?>" class="form-control">
              </div>
              ...
              ">
                ...
                <?php }elseif($getUinfo->roleid == '2'){?>
                  ...
                  <option value="3">User only</option>
                <?php }elseif($getUinfo->roleid == '3'||'0'){?>
                  <option value="0">company</option>
                  <option value="1">Admin</option>
                  <option value="2">Editor</option>
