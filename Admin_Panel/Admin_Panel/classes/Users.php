...
class Users{
  ...
  public function checkExistEmail($email){
    $sql = "SELECT email from  companyinfo WHERE email = :email";
...
<strong>Error !</strong> Email already Exists, please try another Email... !</div>';
      ...
      $sql = "INSERT INTO companyinfo(name, username, email, password, mobile, roleid) VALUES(:name, :username, :email, :password, :mobile, :roleid)";
      $stmt = $this->db->pdo->prepare($sql);
...
<strong>Error !</strong> Email already Exists, please try another Email... !</div>';
  ...
  public function selectAllUserData(){
    $sql = "SELECT * FROM companyinfo ORDER BY id DESC";
    $stmt = $this->db->pdo->prepare($sql);
    $stmt->execute();
  ...
  public function userLoginAutho($email, $password){
    ...
    $sql = "SELECT * FROM companyinfo WHERE email = :email and password = :password LIMIT 1";
    $stmt = $this->db->pdo->prepare($sql);
    $stmt->bindValue(':email', $email);
  ...
  public function CheckActiveUser($email){
    $sql = "SELECT * FROM companyinfo WHERE email = :email and isActive = :isActive LIMIT 1";
    $stmt = $this->db->pdo->prepare($sql);
    $stmt->bindValue(':email', $email);
  ...
  <strong>Error !</strong> Invalid email address !</div>';
    ...
    public function CheckOldPassword($userid, $old_pass){
      ...
      $sql = "SELECT password FROM companyinfo WHERE password = :password AND id =:id";
      $stmt = $this->db->pdo->prepare($sql);
