 ...
 ?>
    ...
    <div class="container">
      ...
      <nav class="navbar navbar-expand-md navbar-dark bg-dark card-header">
        <a class="navbar-brand" href="http://localhost/demo/Admin/admin_dashboard.php"><i class="fas fa-home mr-2"></i>Home</a>
          ...
          <?php if (Session::get('id') == TRUE) { ?>
            <?php if (Session::get('roleid') == '1') { ?>
              ...
              <?php
                ...
                <a class="nav-link" href="http://localhost/Admin/Admin/Addjobs.php"><i class="fas fa-user-plus mr-2"></i>Add jobs </span></a>
              </li>
            <?php  } ?>
            <li class="nav-item
            <?php
