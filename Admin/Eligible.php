            ...
            <div class="container-fluid">
                ...
                <div class="card ">
                    <div class="card-header">
                        <h3 class='text-center'>Eligible Student</h3>
                    </div>
                    <div class="card-body">
                        <div style="width:600px; margin:0px auto">
                            ...
                            <form class="" action="" method="POST">
                                ...
                                <div class="form-group">
                                    <label for="date">Date for Interview</label>
                                    <input type="date" name="date" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="time">Time for Interview</label>
                                    <input type="time" name="time" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="EorN">Eligible Or Not</label>
                                    <div class="input-group mb-3">
                                        <select required class="custom-select" id="inputGroupSelect02" name="EorN">
                                            <option required selected name="EorN">Choose...</option>
                                            <option required value="Eligible" name="EorN">Eligible</option>
                                            <option required value="Not-Eligible" name="EorN">Not-Eligible</option>
                                        </select>
                                    </div>
