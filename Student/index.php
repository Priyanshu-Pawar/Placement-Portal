...
<body>
  ...
  <section id="header">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="vision.html"><img src="https://img.icons8.com/material-rounded/24/000000/vision.png" />VISION</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="resume.html"><img src="https://img.icons8.com/material-sharp/24/000000/open-resume.png" />RESUME</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="preparation.html"><img src="https://img.icons8.com/material-rounded/24/000000/file-settings.png" />PREPARATION</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="quality.html"><img src="https://img.icons8.com/material-rounded/24/000000/warranty.png" />QUALITY</a>
              </li>
    ...
    <div class="banner text-center">
      ...
      <h3>Traning and placement</h3>
    </div>
  </section>

  <div class="login">
    <a href="login.php"><button>Student</button></a>
    <a href="adminLogin.php"><button>Co-ordinator</button></a>
