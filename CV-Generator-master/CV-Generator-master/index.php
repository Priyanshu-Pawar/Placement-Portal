...
<span class="logo">Welcome to Resume Builder </span></div>
        ...
        <form action="submit.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="border border-dark p-3 mb-3">    
                ...
                <div class="mb-3">
                    ...
                    <input type="tel" class="form-control" id="phone" name="phone" placeholder="0300123456" pattern="[0-9]{10}" required>
                </div>
            </div>
            <div class="border border-dark p-3 mb-3">    
                <h2>Skills (Max:5)</h2>
